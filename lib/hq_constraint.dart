...
class HqConstraintPage extends StatelessWidget {
  const HqConstraintPage({super.key});
...
class _FlutterLayoutArticleState extends State<FlutterLayoutArticle> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Constraint Example')),
      body: SafeArea(
          child: Material(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    color: Color.fromARGB(255, 51, 35, 193),
