...
class HqFocusDemoPage extends StatefulWidget {
  const HqFocusDemoPage({super.key});

  @override
  State<HqFocusDemoPage> createState() => _HqFocusDemoPageState();
}

class _HqFocusDemoPageState extends State<HqFocusDemoPage> {
  ...
  Widget _buildStack(BuildContext context, BoxConstraints constraints) {
    ...
    debugPrint('stackSize:$stackSize');
        ...
        body: Stack(
          ...
          children: <Widget>[
              ...
              child: Pane(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    ElevatedButton(
                      onPressed: () =>
                          debugPrint('You pressed the other button!'),
            ...
            AnimatedPositioned(
              ...
              top: backdropIsVisible ? stackSize.height * 0.82 : 0.0,
